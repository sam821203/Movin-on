...
<style>
    ...
    .other-movies-section .age0 {
        background-color: rgba(94, 179, 58, 0.5);
    }

    .other-movies-section .age6 {
        background-color: rgba(26, 162, 229, 0.5);
    }

    .other-movies-section .age12 {
        background-color: rgba(226, 165, 38, 0.5);
    }

    .other-movies-section .age15 {
        background-color: rgba(236, 119, 32, 0.5);
    }

    .other-movies-section .age18 {
        background-color: rgba(227, 11, 32, 0.5);
    }


    .other-movies-section .italic-16 {
...
<body>
    ...
    // $ratingstr = "$('.pg-rate').text()";
    // $arr = explode("," , $ratingstr);
    // echo "<pre>";
    //  print_r($arr); 
    //  echo "</pre>";
    //  -->
