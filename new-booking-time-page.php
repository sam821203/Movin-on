                                            ...
                                            <div class="showtime-options">
                                                ...
                                                <div class="options d-flex flex-wrap">
                                                    ...
                                                    <?php foreach ($time as $stime) { ?>
                                                        <a href="new-booking-seat-page.php?movie_id=<?= $_GET['movie_id'] ?>" 
                                                        data-movie-poster="<?= $objM['poster'] ?>" 
                                                        data-movieTC="<?= $objM['mName_TC'] ?>" 
                                                        data-movieEN="<?= $objM['mName_EN'] ?>" 
                                                        data-date="1月<?= $obj['date'] ?>"
                                                        data-division="<?= $obj['division'] ?>" 
                                                        data-moviecat="<?= $arr3[0]['screen'] ?>" 
                                                        data-showtime="<?= $stime ?>" 
                                                        data-cinema="<?= $hall ?>" 
                                                        data-left-seat="<?= $obj['left_seat'] ?>" 
                                                        data-ticket-poster="<?= $objM['ticket_poster'] ?>" 
                                                        data-pg-rate="<?= $objM['pg_rate_text'] ?>" 
                                                        data-length="<?= $objM['length'] ?>" 
                                                        data-director="<?= $objM['director_TC'] ?>" 
                                                        id="showdetail">
