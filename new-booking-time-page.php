...
<style>
    ...
    .movie-selecting-section .movie-info .movie-poster {
        width: 25%;
    }
            ...
            <div class="container">
                <div class="row movie-info">
                    ...
                    <?php if (isset($_GET['movie_id'])) { ?>
                        <div class="d-flex">
                            <?php
                            $sql = "SELECT `id`, `poster`, `ticket_poster`, `pg_rate`, `movie_TC` , `movie_EN`, `length`, `director_TC`FROM `movie` WHERE `movie_id` = {$_GET['movie_id']}";
                            $arr = $pdo->query($sql)->fetchAll();
                            foreach ($arr as $objM) {
                            ?>
                                <div class="movie-poster">
                                    <div class="img-wrap">
                                        <img src="<?= $objM['poster'] ?>" alt="">
                                    </div>
                                </div>
                                <div class="content">
                                    <div>
                                        <span class="pg-rate body2-r"><?= $objM['pg_rate'] ?></span>
                                    </div>
                                    <div>
                                        <span class="title-tc"><?= $objM['movie_TC'] ?></span>
                                    </div>
                                    <div>
                                        <span class="title-en"><?= $objM['movie_EN'] ?></span>
                                    </div>
                                    <div class="rating">
                                    ...
                                    <p><span class="movie-length"></span>片場：<span class="length-data"><?= $objM['length'] ?>分鐘</span></p>
        ...
        <section class="movie-showtime-section g-section-mb">
            <div class="container">
                ...
                <?php if (
                    ...
                    <?php $sql = "SELECT `cinema_name`,`screen`,`showtime`,`seat`,`left_seat`,`date`
                            FROM `cinema` 
                                        ...
                                        <div class="showtime-options">
                                            ...
                                            <div class="options d-flex flex-wrap">
                                                ...
                                                <?php foreach ($time as $stime) { ?>
                                                    <a href="booking-seat-page-copy.php" data-movie-poster="<?= $objM['poster'] ?>" data-movieTC="<?= $objM['movie_TC'] ?>" data-movieEN="<?= $objM['movie_EN'] ?>" data-date="1月<?= $obj['date'] ?>" data-moviecat="<?= $arr3[0]['screen'] ?>" data-showtime="<?= $stime ?>" data-cinema="<?= $hall ?>" data-left-seat="<?= $obj['left_seat'] ?>" data-ticket-poster="<?= $objM['ticket_poster'] ?>" id="showdetail">
                                                        <div class="showtime d-flex">
                                                            <div class="dot  my-auto mr-2" data-seat="<?= $arrDataSeat[$hall . $stime] ?>" data-left-seat="<?= $arrData[$hall . $stime] ?>"></div>
